    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=150, validators=[django.core.validators.RegexValidator(code='invalid_first_name', message='Имя не может содержать символы: $%^&#:;!', regex='^[^$%^&#:;!]+$')], verbose_name='first name')),
